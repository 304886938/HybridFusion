...
class VodDataset(Custom3DDataset):
    ...
    def __init__(self,
                 ...
                 test_mode=False,
                 pcd_limit_range=[0, -25, -3, 50, 25, 0.0],
                 **kwargs):
        super().__init__(
            data_root=data_root,
            ann_file=ann_file,
    ...
    def _get_lidar_pts_filename(self, idx):
        ...
        """
        lidar_pts_filename = osp.join(self.root_split, self.pts_prefix,
                                f'{idx:06d}.bin')
        return lidar_pts_filename
    
    def _get_radar_pts_filename(self, idx):
        """Get point cloud filename according to the given index.
        ...
        Returns:
            str: Name of the point cloud file.
        """
        radar_pts_filename = osp.join(self.root_split, self.pts_prefix,
                                f'{idx:06d}.bin')
        return radar_pts_filename
    ...
    def get_data_info(self, index):
        ...
        lidar_pts_filename = self._get_lidar_pts_filename(sample_idx)

        radar_pts_filename = self._get_radar_pts_filename(sample_idx)

        input_dict = dict(
            sample_idx=sample_idx,
            lidar_pts_filename=lidar_pts_filename,
            radar_pts_filename=radar_pts_filename,
            img_prefix=None,
    ...
    def get_ann_info(self, index):
        ...
        Returns:
            dict: annotation information consists of the following keys:
                ...
                - difficulty (int): Difficulty defined by VOD.
    ...
    def bbox2result_kitti2d(self,
        ...
        if submission_prefix is not None:
            ...
            mmcv.mkdir_or_exist(submission_prefix)
            print(f'Saving VOD submission to {submission_prefix}')
